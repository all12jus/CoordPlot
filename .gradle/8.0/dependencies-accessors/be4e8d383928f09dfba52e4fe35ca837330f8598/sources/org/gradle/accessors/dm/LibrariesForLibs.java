...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getFonts() { return create("fonts"); }
    ...
    public static class AndroidxComposeLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxComposeIntegrationLibraryAccessors getIntegration() { return laccForAndroidxComposeIntegrationLibraryAccessors; }
    ...
    public static class AndroidxComposeIntegrationLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxComposeIntegrationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getConstraintLayout() { return create("androidx.compose.integration.constraintLayout"); }
    ...
    public static class MaterialLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public MaterialLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getIconsExtended() { return create("material.iconsExtended"); }
    ...
    public static class UiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public UiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getUi() { return create("ui.ui"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: fonts (1.4.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: material3 (1.2.0-alpha02)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: navigation (2.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
         ...
         */
        public ComposeIntegrationVersionAccessors getIntegration() { return vaccForComposeIntegrationVersionAccessors; }
    ...
    public static class BundleAccessors extends BundleFactory {
         ...
         */
        public ComposeBundleAccessors getCompose() { return baccForComposeBundleAccessors; }
    ...
    public static class AndroidxBundleAccessors extends BundleFactory {
        ...
        public AndroidxBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }
             ...
             */
            public Provider<ExternalModuleDependencyBundle> getActivity() { return createBundle("androidx.activity"); }
    ...
    public static class ComposeBundleAccessors extends BundleFactory {
        ...
        public ComposeBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }
             ...
             * This bundle was declared in catalog libs.versions.toml
             */
            public Provider<ExternalModuleDependencyBundle> getUi() { return createBundle("compose.ui"); }
